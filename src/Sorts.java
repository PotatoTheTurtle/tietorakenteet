...
public class Sorts {
    final int MAX=30000;
    public int quicksort = 0;
    public int mergesort = 0;
    public int selectsort = 0;

    public void quickSortLoop() {
        ...
        System.out.println("Vertailujen lukumäärä: ");
    }
    ...
    public void qs(int table[], int values) {
    ...
    private int[] tau = new int[MAX]; // aputaulukko (ei varata tätä pinosta!)
